...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/all.min.css"> <!-- fontawesome -->
    <!-- <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/tailwind.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/tooplate-antique-cafe.css">
...
<body>    
    <!-- Intro -->
    <div id="intro" class="parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/antique-cafe-bg-01.jpg">
    ...
    <!-- Cafe Menu -->
    <div id="menu" class="parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/antique-cafe-bg-02.jpg">
    ...
    <div id="about" class="parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/antique-cafe-bg-03.jpg">
        <div class="container mx-auto tm-container py-24 sm:py-48">
    ...
    <div id="contact" class="parallax-window relative" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/antique-cafe-bg-04.jpg">

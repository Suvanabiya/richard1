...
add_action( 'init', 'create_post_type' );
            function create_post_type() {
                    register_post_type( 'clean_blog',
                            array(
                                    'labels' => array(
                                            'name' => __( 'clean_blog' ),
                                            'singular_name' => __( 'clean_blog' ),
                                            'add_new' => __( 'Add New' ),
                                            'add_new_item' => __( 'Add New clean_blog' ),
                                            'edit_item' => __( 'Edit clean_blog' ),
                                            'new_item' => __( 'New clean_blog' ),
                                            'view_item' => __( 'View clean_blog' ),

  <?php
add_action( 'init', 'creats_servicsspost_type' );
            function creats_servicsspost_type() {
                    register_post_type( 'servicss_News',
                            array(
                                    'labels' => array(
                                            'name' => __( 'servicss_News' ),
                                            'singular_name' => __( 'servicss_News' ),
                                            'add_new' => __( 'Add New' ),
                                            'add_new_item' => __( 'Add New servicss_News' ),
                                            'edit_item' => __( 'Edit servicss_News' ),
                                            'new_item' => __( 'New servicss_News' ),
                                            'view_item' => __( 'View servicss_News' ),
                                            'not_found' => __( 'Sorry, we couldn\'t find the servicss_News you are looking for.' )
                                    ),
                            'public' => true,
                            ...
                            'rewrite' => array( 'slug' => 'servicss_News' ),
...
add_action( 'init', 'creat_servicepost_type' );
            function creat_servicepost_type() {
                    register_post_type( 'service_News',
                            array(
                                    'labels' => array(
                                            'name' => __( 'srrvice_News' ),
                                            'singular_name' => __( 'service_News' ),
                                            'add_new' => __( 'Add New' ),
                                            'add_new_item' => __( 'Add New service_News' ),
                                            'edit_item' => __( 'Edit service_News' ),
                                            'new_item' => __( 'New service_News' ),
                                            'view_item' => __( 'View service_News' ),
                                            'not_found' => __( 'Sorry, we couldn\'t find the service_News you are looking for.' )
                                    ),
                            'public' => true,
                            'publicly_queryable' => false,
                            'exclude_from_search' => true,
                            ...
                            'hierarchical' => false,
                            'capability_type' => 'page',
                            'rewrite' => array( 'slug' => 'service_News' ),
                            'supports' => array( 'title', 'editor', 'thumbnail' )
                            )
                    );
            }
...
add_action( 'init', 'create_post_type' );
            function create_post_type() {
                    register_post_type( 'Breaking_News',
                            array(
                                    'labels' => array(
                                            'name' => __( 'Breaking_News' ),
                                            'singular_name' => __( 'Breaking_News' ),
                                            'add_new' => __( 'Add New' ),
                                            'add_new_item' => __( 'Add New Breaking_News' ),
                                            'edit_item' => __( 'Edit Breaking_News' ),
                                            'new_item' => __( 'New Breaking_News' ),
                                            'view_item' => __( 'View Breaking_News' ),
                            ...
                            'hierarchical' => false,
                            'capability_type' => 'page',
                            'rewrite' => array( 'slug' => 'Breaking_News' ),
                            'supports' => array( 'title', 'editor', 'thumbnail' )
                            )
                    );
            }

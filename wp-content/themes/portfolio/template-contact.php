            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>My contact</h2>
                     <p>Need frish mind,and brithe frish air</p>
                  </div>
               </div>
            </div>
            <div class="row d_flex">
                     ...
                     <div class="carousel-inner">
                           ...
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="trannir_text">
                                    <i><img src="images/download (4).jpeg" alt="#"/></i>
                                    <h3>Afrin</h3>
                                    <span>Travler</span>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="trannir_text">
                                    <i><img src="images/download (2).jpeg" alt="#"/></i>
                                    <h3>Afrin</h3>
                                    <span>Travler</span>
                                    <ul class="social_icon text_align_center">
                                       <li> <a href="Javascript:void(0)"><i class="fa fa-facebook-f"></i></a></li>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="trannir_text">
                                    <i><img src="images/download (3).jpeg" alt="#"/></i>
                                    <h3>Afrin</h3>
                                    <span>Travler</span>
                                    <ul class="social_icon text_align_center">
                                       <li> <a href="Javascript:void(0)"><i class="fa fa-facebook-f"></i></a></li>
               ...
               <div class="row">
                  <div class="col-md-8 offset-md-2">
                     ...
                     <div class="conta text_align_center">
                        <ul>
                           <li> <a href="Javascript:void(0)"><img src="images/call.png" alt="#"/> Call +01814017359
                              </a>
                           </li>
                           <li> <a href="Javascript:void(0)"><img src="images/mall.png" alt="#"/> afrin@gmail.com
                              </a>
                           </li>
                        </ul>
                     </div>
